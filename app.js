...
var uiController = (function () {
  ...
  return {
    displayDate: function () {
      ...
      //console.log("Date: " + unuudur);
      document.querySelector(DOMstrings.dateLabel).textContent =
        unuudur.getFullYear() + " оны " + unuudur.getMonth() + " сарын ";
      //console.log("month: " + unuudur.getMonth()); //0 Why???
    },
    ...
    displayPercentages: function (allPercentages) {
      //Зарлагын NodeList-ийг олох// <button id="">click me</button>
      var elements = document.querySelectorAll(
        DOMstrings.expensePercentageLabel
      );
      //Элемент болгоны хувьд зарлагын хувийг массиваас авч шивж оруулах
      //Expense percentage will be typed by taken from massive for each elements.
...
var appController = (function (uiController, financeController) {
  ...
  var updateTusuv = function () {
    ...
    console.log("each exp-s percentage: " + allPercentages);
